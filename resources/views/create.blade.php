...
<form action="{{ route('create.store') }}" method="POST" class="max-w-xl mx-auto bg-white shadow-lg rounded-lg p-8 space-y-6">
    @csrf
    <h2 class="text-2xl font-bold text-gray-800 mb-4">Tambah Barang Baru</h2>
    <div>
